...
Finalmente, comprobé que el código era correcto implementado la funcion rand5() (usando randi) e hice un histograma en otro archivo para comprobar que la distribución era uniforme usando 100000 muestras.
